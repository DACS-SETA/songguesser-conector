package com.songguesser.conector.exeptions.configuration;
...
import com.songguesser.conector.exeptions.ExceptionResponse;
import com.songguesser.conector.exeptions.GenericException;

import java.util.Locale;

@ControllerAdvice
public class SongGuesserControllerAdvice {

	@Autowired
	protected MessageSource messageSource;

	@Value("${songguesser.exceptions.code-prefix}")
